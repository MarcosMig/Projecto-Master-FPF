...
METRIC_CATALOG = [
    ...
    {"source": "physical", "key": "sprint_10m_s", "label": "Sprint 10m (Aceleracao)", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "sprint_20m_s", "label": "Sprint 20m (Velocidade)", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "teste_505_esq_s", "label": "505 Esq (Agilidade)", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "teste_505_dir_s", "label": "505 Dir (Agilidade)", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "sj_altura_cm", "label": "SJ Altura (Potencia)", "group": "Saltos Simples", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "cmj_altura_cm", "label": "CMJ Altura (Potencia)", "group": "Saltos Simples", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "dj_altura_cm", "label": "DJ Altura (Potencia Reativa)", "group": "Saltos Simples", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "dj_rsi", "label": "DJ RSI (Reatividade)", "group": "Saltos Simples", "unit": "", "direction": "higher"},
    {"source": "physical", "key": "dj_rsi_mod_mps", "label": "DJ RSI Mod (Reatividade)", "group": "Saltos Simples", "unit": "m/s", "direction": "higher"},
    {"source": "physical", "key": "dj_contacto_ms", "label": "DJ Contacto (Reatividade)", "group": "Saltos Simples", "unit": "ms", "direction": "lower"},
    {"source": "physical", "key": "j10_rsi_10_5", "label": "10J RSI 10-5 (Resistencia Reativa)", "group": "10 Jumps", "unit": "", "direction": "higher"},
    {"source": "physical", "key": "j10_cmj_cm", "label": "10J CMJ (Potencia)", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "j10_media_saltos_cm", "label": "10J Media (Resistencia)", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "j10_maximo_cm", "label": "10J Maximo (Potencia)", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "j10_minimo_cm", "label": "10J Minimo (Resistencia)", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "indice_fadiga_10j_pct", "label": "Indice Fadiga 10J (Resistencia)", "group": "10 Jumps", "unit": "%", "direction": "lower"},
    ...
    {"source": "technical", "key": "posicionamento_prontidao_score", "label": "Posicionamento (Tatica GR)", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "defesa_membros_superiores_score", "label": "Defesa Membros Superiores (Tecnica GR)", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "defesa_membros_inferiores_score", "label": "Defesa Membros Inferiores (Tecnica GR)", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "defesa_6m_ocupa_espaco_score", "label": "Defesa 6m (Tatica GR)", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
