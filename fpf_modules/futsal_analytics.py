...
METRIC_CATALOG = [
    {"source": "physical", "key": "peso_kg", "label": "Peso", "group": "Antropometria", "unit": "kg", "direction": "higher"},
    {"source": "physical", "key": "altura_cm", "label": "Altura", "group": "Antropometria", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "envergadura_cm", "label": "Envergadura", "group": "Antropometria", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "comprimento_perna_cm", "label": "Comprimento Perna", "group": "Antropometria", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "altura_sentada_cm", "label": "Altura Sentada", "group": "Antropometria", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "salto_maturacional", "label": "Salto Maturacional", "group": "Antropometria", "unit": "anos", "direction": "higher"},
    {"source": "physical", "key": "sprint_10m_s", "label": "Sprint 10m", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "sprint_20m_s", "label": "Sprint 20m", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "teste_505_esq_s", "label": "505 Esq", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "teste_505_dir_s", "label": "505 Dir", "group": "Velocidade e Agilidade", "unit": "s", "direction": "lower"},
    {"source": "physical", "key": "sj_altura_cm", "label": "SJ Altura", "group": "Saltos Simples", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "cmj_altura_cm", "label": "CMJ Altura", "group": "Saltos Simples", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "dj_altura_cm", "label": "DJ Altura", "group": "Saltos Simples", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "dj_rsi", "label": "DJ RSI", "group": "Saltos Simples", "unit": "", "direction": "higher"},
    {"source": "physical", "key": "dj_rsi_mod_mps", "label": "DJ RSI Mod", "group": "Saltos Simples", "unit": "m/s", "direction": "higher"},
    {"source": "physical", "key": "dj_contacto_ms", "label": "DJ Contacto", "group": "Saltos Simples", "unit": "ms", "direction": "lower"},
    {"source": "physical", "key": "j10_rsi_10_5", "label": "10J RSI 10-5", "group": "10 Jumps", "unit": "", "direction": "higher"},
    {"source": "physical", "key": "j10_cmj_cm", "label": "10J CMJ", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "j10_media_saltos_cm", "label": "10J Media", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "j10_maximo_cm", "label": "10J Maximo", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "j10_minimo_cm", "label": "10J Minimo", "group": "10 Jumps", "unit": "cm", "direction": "higher"},
    {"source": "physical", "key": "indice_fadiga_10j_pct", "label": "Indice Fadiga 10J", "group": "10 Jumps", "unit": "%", "direction": "lower"},
    {"source": "technical", "key": "um_x_um_ofensivo_score", "label": "1x1 Ofensivo", "group": "Tecnico | Tatica", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "um_x_um_defensivo_score", "label": "1x1 Defensivo", "group": "Tecnico | Tatica", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "lateralidade_score", "label": "Lateralidade", "group": "Tecnico | Tatica", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "imprevisibilidade_score", "label": "Imprevisibilidade", "group": "Tecnico | Tatica", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "leitura_jogo_score", "label": "Leitura de Jogo", "group": "Tecnico | Tatica", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "dominio_espaco_score", "label": "Dominio do Espaco", "group": "Tecnico | Tatica", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "posicionamento_prontidao_score", "label": "Posicionamento", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "defesa_membros_superiores_score", "label": "Defesa Membros Superiores", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "defesa_membros_inferiores_score", "label": "Defesa Membros Inferiores", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "defesa_6m_ocupa_espaco_score", "label": "Defesa 6m", "group": "Tecnico | Tatica GR", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "espirito_equipa_score", "label": "Espirito de Equipa", "group": "Psicologico", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "controlo_emocional_score", "label": "Controlo Emocional", "group": "Psicologico", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "tenacidade_resiliencia_score", "label": "Tenacidade | Resiliencia", "group": "Psicologico", "unit": "score", "direction": "higher"},
    {"source": "technical", "key": "atencao_concentracao_score", "label": "Atencao | Concentracao", "group": "Psicologico", "unit": "score", "direction": "higher"},
]
